...
/// Signature used by [GestureScrollable] to build the viewport through which the
...
///
/// [GestureScrollable] implements the interaction model for a scrollable widget,
/// including gesture recognition, but does not have an opinion about how the
/// viewport, which actually displays the children, is constructed.
///
/// It's rare to construct a [GestureScrollable] directly. Instead, consider [ListView]
/// or [GridView], which combine scrolling, viewporting, and a layout model. To
/// combine layout models (or to use a custom layout mode), consider using
/// [CustomScrollView].
///
/// The static [GestureScrollable.of] and [GestureScrollable.ensureVisible] functions are
/// often used to interact with the [GestureScrollable] widget inside a [ListView] or
/// a [GridView].
///
...
class GestureScrollable extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const GestureScrollable({
    Key? key,
  ...
  /// [ScrollAction].
  ///
  /// If not supplied, the [GestureScrollable] will scroll a default amount when a
  ...
  /// Whether the scroll actions introduced by this [GestureScrollable] are exposed
  ...
  @override
  GestureScrollableState createState() => GestureScrollableState();
  ...
  /// ```
  ///
  /// Calling this method will create a dependency on the closest [GestureScrollable]
  /// in the [context], if there is one.
  static GestureScrollableState? of(BuildContext context) {
  ...
  ///
  /// The heuristic used is determined by the [physics] of this [GestureScrollable]
  ...
  ///
  /// If there is no [GestureScrollable] in the widget tree above the [context], this
  ...
  static Future<void> ensureVisible(
    ...
    GestureScrollableState? scrollable = GestureScrollable.of(context);
    while (scrollable != null) {
      ...
      scrollable = GestureScrollable.of(context);
    }
...
class _ScrollableScope extends InheritedWidget {
  ...
  final GestureScrollableState scrollable;
...
/// State object for a [GestureScrollable] widget.
///
/// To manipulate a [GestureScrollable] widget's scroll position, use the object
/// obtained from the [position] property.
///
/// To be informed of when a [GestureScrollable] widget is scrolling, use a
/// [NotificationListener] to listen for [ScrollNotification] notifications.
///
/// This class is not intended to be subclassed. To specialize the behavior of a
/// [GestureScrollable], provide it with a [ScrollPhysics].
class GestureScrollableState extends State<GestureScrollable>
    with TickerProviderStateMixin, RestorationMixin
    implements ScrollContext {
  /// The manager for this [GestureScrollable] widget's viewport position.
  ///
  /// To control what kind of [ScrollPosition] is created for a [GestureScrollable],
  ...
  bool _shouldUpdatePosition(GestureScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(GestureScrollable oldWidget) {
    ...
    Widget result = _ScrollableScope(
      ...
      child: Listener(
        ...
        onPointerDown: (event) => setState(() {
          _pointerCount = _pointerCount + 1;
          if (_drag != null && _pointerCount > 1) {
            _hold?.cancel();
            _drag?.cancel();
          }
        }),
...
///
/// This function is used as the type for [GestureScrollable.incrementCalculator],
...
/// [ScrollAction] on a [GestureScrollable].
///
/// This is used to configure a [ScrollIncrementDetails] object to pass to a
/// [ScrollIncrementCalculator] function on a [GestureScrollable].
///
...
/// [GestureScrollable.incrementCalculator], or by its defaults if that is not
/// specified.
...
/// An [Action] that scrolls the [GestureScrollable] that encloses the current
...
/// [ScrollAction]s.
///
/// If [GestureScrollable.incrementCalculator] is null for the scrollable, the default
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  bool isEnabled(ScrollIntent intent) {
    ...
    if (contextIsValid) {
      ...
      if (GestureScrollable.of(focus.context!) != null) return true;
      ...
      if (PrimaryScrollController.of(focus.context!) != null) {
        ...
        return primaryScrollController != null &&
            ...
            primaryScrollController.position.context.notificationContext !=
                null &&
            GestureScrollable.of(primaryScrollController
  ...
  double _calculateScrollIncrement(GestureScrollableState state,
  ...
  double _getIncrement(GestureScrollableState state, ScrollIntent intent) {
  ...
  void invoke(ScrollIntent intent) {
    GestureScrollableState? state =
        GestureScrollable.of(primaryFocus!.context!);
    if (state == null) {
      final ScrollController? primaryScrollController =
          PrimaryScrollController.of(primaryFocus!.context!);
      state = GestureScrollable.of(
          primaryScrollController!.position.context.notificationContext!);
    }
    assert(state != null,
